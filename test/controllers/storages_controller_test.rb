...
class StoragesControllerTest < ActionController::TestCase
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post :create, storage: { description: @storage.description, name: @storage.name, path: @storage.path, type: @storage.type }
    end
  ...
  test "should update storage" do
    patch :update, id: @storage, storage: { description: @storage.description, name: @storage.name, path: @storage.path, type: @storage.type }
    assert_redirected_to storage_path(assigns(:storage))
  end
